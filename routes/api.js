...
router.get('/getpurchasesuppliertracker/:supplierId',AuthVarification,ItemController.getpurchasesuppliertracker)
...
router.post('/customerDetails',AuthVarification,SaleItemController.customerDetails)
