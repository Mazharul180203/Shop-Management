/*
  ...
  - Added the required column `voucher_no` to the `customerledger` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `customerledger` ADD COLUMN `voucher_no` VARCHAR(191) NOT NULL,
