/*
  ...
  - You are about to alter the column `total_qty` on the `sales` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Double`.
...
-- AlterTable
ALTER TABLE `sales` MODIFY `total_qty` DOUBLE NOT NULL,
