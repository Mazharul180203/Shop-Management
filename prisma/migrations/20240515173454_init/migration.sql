/*
  ...
  - You are about to drop the column `purchas_update_qty` on the `purchaseitems` table. All the data in the column will be lost.
  ...
  - Added the required column `purchase_update_qty` to the `purchaseitems` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchaseitems` DROP COLUMN `purchas_update_qty`,
    ADD COLUMN `purchase_update_qty` DOUBLE NOT NULL,
