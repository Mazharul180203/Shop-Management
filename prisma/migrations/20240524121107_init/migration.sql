/*
  ...
  - You are about to drop the column `voucher_no` on the `supplierledger` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `supplierledger` DROP COLUMN `voucher_no`,
