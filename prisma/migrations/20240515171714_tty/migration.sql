/*
  ...
  - Added the required column `purchas_update_qty` to the `purchaseitems` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchaseitems` ADD COLUMN `purchas_update_qty` DOUBLE NOT NULL,
