/*
  ...
  - You are about to drop the column `credit` on the `purchasesuppliertrack` table. All the data in the column will be lost.
  - You are about to drop the column `debit` on the `purchasesuppliertrack` table. All the data in the column will be lost.
  ...
  - Added the required column `balance` to the `purchasesuppliertrack` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchasesuppliertrack` DROP COLUMN `credit`,
    DROP COLUMN `debit`,
