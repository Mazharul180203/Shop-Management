/*
  ...
  - Added the required column `voucher_no` to the `supplierledger` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `supplierledger` ADD COLUMN `voucher_no` VARCHAR(191) NOT NULL,
