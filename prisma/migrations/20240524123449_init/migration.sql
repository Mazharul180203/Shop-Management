/*
  ...
  - You are about to drop the column `balance` on the `purchasesuppliertrack` table. All the data in the column will be lost.
  ...
  - Added the required column `curr_balance` to the `purchasesuppliertrack` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchasesuppliertrack` DROP COLUMN `balance`,
    ADD COLUMN `curr_balance` DOUBLE NOT NULL,
