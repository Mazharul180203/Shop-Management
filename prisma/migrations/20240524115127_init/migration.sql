/*
  ...
  - Added the required column `supplierId` to the `supplierledger` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `supplierledger` ADD COLUMN `supplierId` INTEGER NOT NULL,
