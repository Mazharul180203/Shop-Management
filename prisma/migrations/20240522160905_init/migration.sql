/*
  ...
  - Added the required column `payemt_type` to the `purchasesuppliertrack` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchasesuppliertrack` ADD COLUMN `payemt_type` VARCHAR(191) NOT NULL,
