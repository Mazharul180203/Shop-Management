/*
  ...
  - Added the required column `price_avg` to the `purchaseitems` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `purchaseitems` ADD COLUMN `price_avg` DOUBLE NOT NULL,
